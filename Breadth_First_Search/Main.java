...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("\n\n\n\t---- Busqueda en Anchura ----");
        Breadth_First_Search anchura = new Breadth_First_Search(new_york, los_angeles, grafo);
        List<Node> breadth_result = anchura.busquedaAnchura();
        anchura.imprimirBusquedaAnchura(breadth_result);
